...
export class Backend implements backendInterface {
    ...
    async deleteMessage(arg0: Principal, arg1: Time): Promise<void> {
        if (this.processError) {
            try {
    ...
    async searchUsers(arg0: string): Promise<Array<[Principal, string]>> {
        if (this.processError) {
            try {
    ...
    async startConversation(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateEncryptionKey(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateEncryptionKey(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
